...
import { ReactComponent as SearchIcon } from "./search-outline-svgrepo-com.svg?react";
import { ReactComponent as MoreDotIcon } from "./moredot.svg?react";
import { ReactComponent as AlertHexaIcon } from "./alert-hexa.svg?react";
import { ReactComponent as ErrorHexaIcon } from "./info-hexa.svg?react";
import { ReactComponent as PeoplePointer } from "./people-pointer.svg?react";
import { ReactComponent as GisTreeView } from "./gistreeview-logo.svg?react";
import { ReactComponent as TreeTreeView } from "./tree-tree.svg?react";
import { ReactComponent as PinMarkMap } from "./pin-mark.svg?react";
// Export semua icon sebagai ReactComponent agar konsisten pewarisan warna dan penggunaan
  export {
    ErrorHexaIcon,
    AlertHexaIcon,
    MoreDotIcon,

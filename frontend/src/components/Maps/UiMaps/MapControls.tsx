        ...
        {role !== null ? (
          <>
            <div className="mt-2">
              <LayerPicker
                baseLayer={baseLayer}
                onChange={(v: BaseLayer) => {
                  setBaseLayer(v);
                  showAlert(
                    "info",
                    t("userMap.alerts.layerSwitchedTitle"),
                    t("userMap.alerts.layerSwitchedMessage", { layer: v })
                  );
                }}
                btnSize={btnSize}
                open={activeControl === "layers"}
                onOpenChange={(v: boolean) =>
                  setExclusiveControl(v ? "layers" : null)
                }
              />
            </div>
                  ...
                  >
                    <PanelBox width="w-56 sm:w-64" className="p-2 sm:p-3">
                      ...
                      <div className="flex flex-col gap-2 text-xs sm:text-sm">
                        ...
                        <label
                          htmlFor="mapcontrols-editroad-name"
                          className="text-xs text-gray-600 dark:text-gray-300"
                        >
                          {t("userMap.editRoad.nameLabel")}
                        </label>
                        <input
                          id="mapcontrols-editroad-name"
                        ...
                        <div className="grid grid-cols-5 gap-2">
                          {PALETTE.map((sw: string) => (
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                setEditingProps({ ...editingProps, color: sw })
                              }
                              title={sw}
                                    ...
                                    updated.features = updated.features.map(
                                      (f: GeoJSON.Feature) => {
                                        ...
                                        if (
                                          ...
                                          const newProps: RoadFeatureProperties =
                                            {
                                              ...p,
                                              nameroad: editingProps.nameroad,
            ...
            <div className="mt-2">
              <StatusFilterButton
                filters={filters}
                onChange={(s: FiltersType) => setFilters(s)}
                btnSize={btnSize}

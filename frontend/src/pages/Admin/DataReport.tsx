...
export default function DataReport() {
  ...
  const filtered = reports.filter((r) => {
    ...
    const statusMatches =
      ...
      (!r.status &&
        (showPending || showRejected || showVerified || showResolved));
    return (
      statusMatches &&
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-2 px-2 md:px-4">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="relative w-full max-w-xs">
              <label htmlFor="reportSearch" className="sr-only">
                Search reports
              </label>
              <input
        ...
        <div className="overflow-x-auto">
          <TableReport
            reports={paged.map((r) => {
              ...
              if (
                Array.isArray(r.reportPictures) &&
                r.reportPictures.length > 0
              ) {
